...
public class BankAccount {
	 ...
	 *            the initial balance of the BankAccount
	 * @param accountNumber
	 *            The account number to associate with this BankAccount. Must be
	 *            a 5 digit integer.
	 */
	public BankAccount(double initialBalance, int accountNumber) {
		...
		else if (9999 < accountNumber && accountNumber < 100000) {
			throw new IllegalArgumentException(
					"Account numbers must be 5 digits long!");
		}
		else {
	...
	public void withdraw(double amount) throws InsufficientFundsException {
		...
		if (this.getBalance() < amount) {
			throw new InsufficientFundsException("Can't withdraw more money than you have!");
		}
		balance = balance - amount;
	}
